...
<h3 title="Aggregated codebase size and recent evolution snapshot">
  🟩 A Matrix <small>(Ref. 21/05/2026)</small>
</h3>

<blockquote title="Total lines">
  ∑ Soma dos repositórios: <strong>6.948.175 linhas</strong>
</blockquote>
...
- `spsp-plus`: Δ **+510** linhas (∑ **4.871.473**)  
  └── + 771 | - 261
- `spsp-site`: Δ **+0** linhas (∑ **1.894.425**)  
  └── + 0 | - 0
- `hybrid-codebase`: Δ **+0** linhas (∑ **127.481**)  
  └── + 44 | - 44
- `spsp-protheus`: Δ **+3.119** linhas (∑ **38.571**)  
  └── + 3.871 | - 752
