...
<h3 title="Aggregated codebase size and recent evolution snapshot">
  🟩 A Matrix <small>(Ref. 29/04/2026)</small>
</h3>

<blockquote title="Total lines">
  ∑ Soma dos repositórios: <strong>6.943.608 linhas</strong>
</blockquote>
...
- `spsp-plus`: Δ **-948** linhas (∑ **4.866.994**)  
  └── + 5.780 | - 6.728
- `spsp-site`: Δ **+0** linhas (∑ **1.894.425**)  
  └── + 0 | - 0
- `hybrid-codebase`: Δ **+0** linhas (∑ **127.393**)  
  └── + 0 | - 0
- `spsp-protheus`: Δ **+830** linhas (∑ **38.571**)  
  └── + 1.492 | - 662
