...
<h3 title="Aggregated codebase size and recent evolution snapshot">
  🟩 A Matrix <small>(Ref. 05/09/2026)</small>
</h3>

<blockquote title="Total lines">
  ∑ Soma dos repositórios: <strong>7.167.409 linhas</strong>
</blockquote>
...
- `spsp-plus`: Δ **+2.310** linhas (∑ **4.959.410**)  
  └── + 7.753 | - 5.443
- `spsp-site`: Δ **+0** linhas (∑ **1.894.425**)  
  └── + 0 | - 0
- `hybrid-codebase`: Δ **+10.052** linhas (∑ **255.156**)  
  └── + 53.048 | - 42.996
- `spsp-protheus`: Δ **+1.081** linhas (∑ **42.193**)  
  └── + 2.734 | - 1.653
