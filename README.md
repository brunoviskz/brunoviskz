...
<h3 title="Aggregated codebase size and recent evolution snapshot">
  🟩 A Matrix <small>(Ref. 10/04/2026)</small>
</h3>

<blockquote title="Total lines">
  ∑ Soma dos repositórios: <strong>6.938.156 linhas</strong>
</blockquote>
...
- `spsp-plus`: Δ **+10.015** linhas (∑ **4.861.579**)  
  └── + 12.045 | - 2.030
- `spsp-site`: Δ **+0** linhas (∑ **1.894.425**)  
  └── + 0 | - 0
- `hybrid-codebase`: Δ **+0** linhas (∑ **127.356**)  
  └── + 54 | - 54
- `spsp-protheus`: Δ **+723** linhas (∑ **38.571**)  
  └── + 2.593 | - 1.870
